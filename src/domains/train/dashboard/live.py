...
from src.config.train.metrics import DASHBOARD_MIN_ELAPSED_SECONDS, DASHBOARD_REFRESH_SECONDS
from src.domains.train.dashboard.view import (
    format_sparkline,
    build_timing_table,
    format_metric_value,
    format_progress_bar,
...
if TYPE_CHECKING:
    ...
    from src.state.train.dashboard import TrainUpdate
    from src.state.train.metrics import EvaluationMetrics, EvaluationSummary
...
class TrainDashboard:
    ...
    def header_panel(self) -> Panel:
        ...
        return Panel(table, title="Yap Phone Screenshot Classifier", border_style="cyan")
