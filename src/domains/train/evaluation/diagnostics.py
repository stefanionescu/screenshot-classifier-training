...
from src.config.train.artifacts import TRAIN_CALIBRATION_FILENAME
from src.state.train.eval import CalibrationReport, CalibrationThresholds, ConfidenceBucket, PredictionRow
...
if TYPE_CHECKING:
    ...
    from src.state.train.eval import EvalArtifacts, PredBatch
