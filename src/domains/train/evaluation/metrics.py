...
from src.domains.train.model.hardware import cpu_label
from src.domains.train.model.network import public_logits
from src.domains.train.model.onnx.runtime import create_onnx_session
from src.state.train.metrics import EvaluationMetrics, TimingContext, TimingMetrics
from src.domains.train.evaluation.stats import latency_stats, metrics_from_confusion
from src.config.train.model import TRAIN_DEVICE_CPU, TRAIN_DEVICE_CUDA, TRAIN_DEVICE_MPS
from src.domains.train.evaluation.diagnostics import prediction_rows, write_failures_from_rows, write_prediction_rows
from src.state.train.eval import (
    OnnxEval,
    OnnxLoop,
    PredBatch,
    TorchEval,
...
if TYPE_CHECKING:
    ...
    from src.state.train.training import BatchData
