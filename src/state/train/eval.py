...
if TYPE_CHECKING:
    ...
    from src.state.train.metrics import TimingContext
    from src.state.train.types import SampleMeta, TrainModel
    from src.state.train.training import BatchData, LabelState
